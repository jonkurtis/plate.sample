...
export const initialValueExcalidraw = (
  <fragment>
    <hh2>🎨 Excalidraw</hh2>
...
export const initialValuePlaceholder = (
  <fragment>
    <hh1>
      <htext />
    </hh1>
...
export const initialValueEmbeds = (
  <fragment>
    <hh2>🎥 Media Embed</hh2>
    <hp>
...
export const initialValueBalloonToolbar = (
  <fragment>
    <hp>
...
export const initialValueImages = (
  <fragment>
    <hh2>📷 Image</hh2>
    <hp>
...
export const initialValueLinks = (
  <fragment>
    <hh2>🔗 Link</hh2>
    <hp>
...
export const initialValuePreview = (
  <fragment>
...
export const initialValueMentions = (
  <fragment>
    <hh2>💬 Mention</hh2>
    <hp>
...
export const initialValuePasteHtml = [
  {
    type: ELEMENT_H1,
    children: [
      {
...
export const initialValuePasteMd = [
  {
    type: ELEMENT_H1,
    children: [
      {
...
export const initialValuePlainText = [
  {
    type: ELEMENT_PARAGRAPH,
    children: [
      {
...
export const initialValueBasicMarks = [
...
export const initialValueHighlight = [
  {
    type: ELEMENT_H2,
    children: [
      {
...
export const initialValueSearchHighlighting = [
  {
    type: ELEMENT_PARAGRAPH,
    children: [
      {
...
export const initialValueTables = [
  {
    type: ELEMENT_H2,
    children: [
      {
...
export const initialValueSoftBreak = [
  {
    type: ELEMENT_H1,
...
export const initialValueExitBreak = [
  {
    type: ELEMENT_H1,
...
export const initialValuePlayground = getNodesWithRandomId([
